...
create_clock -add -name clk -period 14.00 -waveform {0 6} [get_ports clk]
...
set_property PACKAGE_PIN E16 [get_ports b_Sign]						
...
set_property PACKAGE_PIN T16 [get_ports b_Enter]						
